...
Reason:
The majority of inbox messages are handled deterministically through
rules. Only a small subset require reasoning, retrieval, memory,
ambiguity resolution, or safety analysis.

A custom modular architecture reduced complexity and made safety gates,
retrieval grounding, and prompt-injection protection easier to audit.
